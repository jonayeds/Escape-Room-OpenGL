...
// texture IDs
unsigned int woodTex, brickTex, sceneryTex, doorTex, metalTex, concreteTex, bookPagesTex, bookCoverTex, painting1Tex;
...
ComponentPosition wallFramePosition = {6.44f, 6.56f, -0.5f, 0.5f, -3.1f, -1.9f};
